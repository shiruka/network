...
publishing {
  publications {
    val publication = create<MavenPublication>("mavenJava") {
      ...
      pom {
        name.set("Network")
        description.set("A network library to handle RakNet packets.")
        ...
        scm {
          connection.set("scm:git:git://github.com/shiruka/network.git")
          developerConnection.set("scm:git:ssh://github.com/shiruka/network.git")
          url.set("https://github.com/shiruka/network")
        }
      }
    }
